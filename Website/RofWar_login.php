        ...
        <div id="container">
            ...
            <div id="content">
				...
				# due to users role the redirection is dynamically set to the right page
					...
					{
						header("Location: RofWar_LoggedOn_Admin.php");
					}
					else if($row->role == "redAirAdmin")
					{
						header("Location: RofWar_LoggedOn_RedAirAdmin.php");
					}
					else if($row->role == "redGroundAdmin")
					{
						header("Location: RofWar_LoggedOn_redGroundAdmin.php");
					}
					else if($row->role == "blueAirAdmin")
					{
						header("Location: RofWar_LoggedOn_blueAirAdmin.php");
					}
					else if($row->role == "blueGroundAdmin")
					{
						header("Location: RofWar_LoggedOn_blueGroundAdmin.php");
					}
					else if($row->role == "viewer")
					{
						header("Location: RofWar_LoggedOn_Viewer.php");
					}			
					exit;
					} 
				else 
				...
				if(!isset($_SESSION["username"])) 
					{
						echo "<form action=\"RofWar_loginForm.php\" >\n";
