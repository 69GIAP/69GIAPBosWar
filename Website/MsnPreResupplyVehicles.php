	...
	<div id="wrapper">
        ...
        <div id="container">
            ...
            <div id="content">
                ...
                ?>
                <p>In interpretation of the rules/mission results Admin needs to tell the planners what resupply vehicles are availiable for the next mission and where they can be placed subject to supply point problems. We will leave this as a manual process for Beta</p>
