	...
	<div id="wrapper">
        ...
        <div id="container">
            ...
            <div id="content">
				...
				<?php
				echo "<br>After a mission has been flown and the statistics generated by the parser all objects that have been killed will have been recorded in the post mortem table.
				This session will delete the killed objects from the columns and statics, then will update the new Z X position of the columns that have survived. <br>";
					...
					# check what missions have been run and processed
					
					$mission_no = 0;
					$q0 = "select * from post_mortem where processed = 0 limit 1";
					$r0 = mysqli_query($camp_link,$q0);
####################"
	$r0_data = mysqli_fetch_row($r0);
	if ($r0_data[0]) 
		{
			$mission_no = $r0_data[5];
			echo '<br> Found unprocessed mission :'.$mission_no;
		}	
	else
...
########################
					if ($mission_no > 0)
					{
					echo "<br>Mission ".$mission_no." has been flown I will now process the results<br>";
					...
					# Now delete any columns that have a quantity less than 1
					#$q6 = "delete from columns where Quantity < 1";
					#$r6 = mysqli_query($camp_link,$r6);
					# Now replace current x z with destination for columns
					$q7 = "update columns set XPos = dest_XPos";
					$r7 = mysqli_query($camp_link,$q7);
					$q8 = "update columns set ZPos = dest_ZPos";
					$r8 = mysqli_query($camp_link,$q8);
					}
					else
					{
					echo "<br>No mission results to process<br>";
					}					
					

                ?>
                <br>Finished update<br>
