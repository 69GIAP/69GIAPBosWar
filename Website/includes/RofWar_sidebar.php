			...
			<?php
				...
				if (!empty($_SESSION["username"]))
					{		
						...
						if ($role == "administrator")
							{
								echo "<h1>Admin:</h1>\n";
								echo "	<ul id=\"sidebar\">\n";
								echo "		<li><a href=\"RofWar_UserAdministration.php?link=A\" class=\"adminBanner\"><span></span></a></li>\n";
								echo "		<li><a href=\"RofWar_UserAdministration.php?link=R\" class=\"sovietBanner\"><span></span></a></li>\n";
								echo "		<li><a href=\"RofWar_UserAdministration.php?link=B\" class=\"centerBanner\"><span></span></a></li>\n";
								echo "		<li><a href=\"RofWar_UserAdministration.php?link=V\" class=\"viewerBanner\"><span></span></a></li>\n";                               
								echo "	</ul>\n";
							}
						...
						# define what a blueAirAdmin or blueGroundAdmin sees in the sidebar
