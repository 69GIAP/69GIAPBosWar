        ...
        <div id="container">
            ...
            <div id="content">
				...
				<?php
					...
					echo "<p>You should create a directory somewhere on your computer where we will place all the template and .Group files which will be exchanged between the mission editor and the BOSWAR campaign manager for this campaign.<br /> You may be running multiple campaigns in parallel so make it unique to the campaign, e.g. $abbrv-groups.<br /> Otherwise there could be confusion between the campaigns.<br /> We will refer to this directory as your \"campaign groups directory\".</p>\n";
					echo "<p>In the BOSWAR campaign manager (while connected to your campaign ($campaign), select \"User Management\" from the upper menu bar.<br /> Scroll down to \"Choose the default folder for your Group Files:\" and enter the full path and folder name there, then click \"Save\".</p>\n";
				  ...
				  // 	Currently in ROF there are two main campaign maps, the <b>Western Front map (05.01.18, etc)</b> and the <b>Channel map</b>.  Then there are also two small dogfight maps: <b>df3xlake</b> and <b>df5x5verdun</b>.</p>\n";
					...
					echo "<p>In the mission editor File menu, select 'Save As...', giving it a file name of the abbreviation for the campaign plus\"_template\" (e.g. $abbrv_template.Mission) and saving it to your campaign groups directory.</p>\n";
...
<?php
					...
					echo "<p>Next in the File menu, select \"Save selection to File\", select /data/Multiplayer/Dogfight/ and save the file as campaign_abbreviation-no-trunc (e.g. $abbrv-no-trunc.Group).</p>
