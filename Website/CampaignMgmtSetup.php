        ...
        <div id="container">
            ...
            <div id="content">
				...
				<?php
					...
					echo "<p>In the mission editor File menu, select 'Save As...', giving it the file name  $abbrv-template.Mission) and saving it to your $abbrv-groups directory.</p>\n";
...
<?php
					...
					echo "<p>Next in the File menu, select \"Save selection to File\", navigate back to your $abbrv-groups directory, give this file the File Name $abbrv-no-trunc.Groups, and as type Mission Files, and click \"Save\".</p>
