...
//					echo "\$fi: $fi<br />\n";
					...
					echo "<h2>Import $campaign Campaign Columns and Statics from template</h2>";
					...
					// start form
					echo "<form id=\"campaignMgmtImportForm\" name=\"campaignImport\" action=\"CampaignMgmtImportConfirm2.php?btn=campStp&sde=campSet\" method=\"post\">\n";
