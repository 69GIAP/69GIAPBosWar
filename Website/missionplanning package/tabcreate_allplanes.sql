# V1.0
# Stenka's script to create test table for the planes on the active airfields 9/9/13
# use for initial create will crush data
# 
CREATE DATABASE IF NOT EXISTS stalingrad1_db ;
USE stalingrad1_db;
SHOW TABLES;
DROP TABLE IF EXISTS allplanes;
...
l12 	VARCHAR(200) DEFAULT '  Model = "graphics\airfields\fr_med.mgm";',
l13 	VARCHAR(200) DEFAULT '  Script = "LuaScripts\WorldObjects\fr_med.txt";',
...
# mcu indfex must match af_LinkTrid
