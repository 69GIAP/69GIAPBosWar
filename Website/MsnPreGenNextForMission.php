	...
	<div id="wrapper">
        ...
        <div id="container">
            ...
            <div id="content">
                ...
                ?>
                <p>This will launch the generation of all the group files needed to create the next mission for alpha it can be one by one for beta one batch for all</p>
