...
CREATE TABLE `campaign_status` (
  ...
  `campaign_status` varchar(35) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `campaign_status` VALUES (1,'Hidden'),(2,'Completed'),(3,'Active'),(4,'Proposed'),(5,'Hidden<br>configured');
...
-- Dump completed on 2014-05-18  9:04:57
